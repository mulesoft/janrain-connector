...
import org.mule.modules.janrain.processors.SetFeaturesMessageProcessor;
...
public class SetFeaturesDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetFeaturesMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "features", "features");
