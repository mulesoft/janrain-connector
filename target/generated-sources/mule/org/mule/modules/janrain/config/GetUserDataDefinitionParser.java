...
import org.mule.modules.janrain.processors.GetUserDataMessageProcessor;
...
public class GetUserDataDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetUserDataMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "identifier", "identifier");
        parseProperty(builder, element, "extended", "extended");
