...
import org.mule.modules.janrain.processors.VerifyDomainMessageProcessor;
...
public class VerifyDomainDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(VerifyDomainMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "code", "code");
