...
import org.mule.modules.janrain.processors.GetAuthorizationCodeMessageProcessor;
...
public class GetAuthorizationCodeDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetAuthorizationCodeMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "transaction_state", "transaction_state");
        parseProperty(builder, element, "lifetime", "lifetime");
