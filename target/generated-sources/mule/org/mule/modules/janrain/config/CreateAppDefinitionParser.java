...
import org.mule.modules.janrain.processors.CreateAppMessageProcessor;
...
public class CreateAppDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateAppMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "partnerKey", "partnerKey");
        parseProperty(builder, element, "email", "email");
        parseProperty(builder, element, "displayName", "displayName");
