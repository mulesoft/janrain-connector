...
import org.mule.modules.janrain.processors.MapMessageProcessor;
    ...
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(MapMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "identifier", "identifier");
        parseProperty(builder, element, "primaryKey", "primaryKey");
        parseProperty(builder, element, "overwrite", "overwrite");
