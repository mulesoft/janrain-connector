...
import org.mule.modules.janrain.processors.AuthInfoMessageProcessor;
...
public class AuthInfoDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(AuthInfoMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "token", "token");
        parseProperty(builder, element, "extended", "extended");
        parseProperty(builder, element, "tokenURL", "tokenURL");
