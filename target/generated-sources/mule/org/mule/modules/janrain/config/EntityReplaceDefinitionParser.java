...
import org.mule.modules.janrain.processors.EntityReplaceMessageProcessor;
...
public class EntityReplaceDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(EntityReplaceMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "include_record", "include_record");
