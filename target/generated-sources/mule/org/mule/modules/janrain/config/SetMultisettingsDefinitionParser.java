...
import org.mule.modules.janrain.processors.SetMultisettingsMessageProcessor;
...
public class SetMultisettingsDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetMultisettingsMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "items", "items");
