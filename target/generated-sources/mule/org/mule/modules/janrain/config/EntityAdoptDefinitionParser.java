...
import org.mule.modules.janrain.processors.EntityAdoptMessageProcessor;
...
public class EntityAdoptDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(EntityAdoptMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "child_id", "child_id");
