...
import org.mule.modules.janrain.processors.AddAdminMessageProcessor;
...
public class AddAdminDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(AddAdminMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "partnerKey", "partnerKey");
        parseProperty(builder, element, "email", "email");
        parseProperty(builder, element, "verify", "verify");
