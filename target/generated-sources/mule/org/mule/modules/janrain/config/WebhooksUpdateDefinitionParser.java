...
import org.mule.modules.janrain.processors.WebhooksUpdateMessageProcessor;
...
public class WebhooksUpdateDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(WebhooksUpdateMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "callback", "callback");
        parseProperty(builder, element, "event_type", "event_type");
        parseProperty(builder, element, "entity_type", "entity_type");
