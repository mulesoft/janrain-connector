...
import org.mule.modules.janrain.processors.UnmapMessageProcessor;
...
public class UnmapDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(UnmapMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "identifier", "identifier");
        parseProperty(builder, element, "allIdentifiers", "allIdentifiers");
        parseProperty(builder, element, "primaryKey", "primaryKey");
        parseProperty(builder, element, "unlink", "unlink");
