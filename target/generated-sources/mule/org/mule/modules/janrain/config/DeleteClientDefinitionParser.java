...
import org.mule.modules.janrain.processors.DeleteClientMessageProcessor;
...
public class DeleteClientDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DeleteClientMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "client_id_for_deletion", "client_id_for_deletion");
