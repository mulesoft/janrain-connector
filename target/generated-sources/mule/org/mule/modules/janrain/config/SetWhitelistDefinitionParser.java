...
import org.mule.modules.janrain.processors.SetWhitelistMessageProcessor;
...
public class SetWhitelistDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetWhitelistMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "whitelist", "whitelist");
