...
import org.mule.modules.janrain.processors.EntityFindMessageProcessor;
...
public class EntityFindDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(EntityFindMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "max_results", "max_results");
        parseProperty(builder, element, "first_result", "first_result");
        parseProperty(builder, element, "show_total_count", "show_total_count");
        parseProperty(builder, element, "sort_on", "sort_on");
