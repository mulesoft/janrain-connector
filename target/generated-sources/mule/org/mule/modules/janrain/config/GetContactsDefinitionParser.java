...
import org.mule.modules.janrain.processors.GetContactsMessageProcessor;
    ...
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetContactsMessageProcessor.class.getName());
        builder.setScope(BeanDefinition.SCOPE_PROTOTYPE);
        parseConfigRef(element, builder);
        parseProperty(builder, element, "identifier", "identifier");
        parseProperty(builder, element, "contactType", "contactType");
        parseProperty(builder, element, "existingUser", "existingUser");
