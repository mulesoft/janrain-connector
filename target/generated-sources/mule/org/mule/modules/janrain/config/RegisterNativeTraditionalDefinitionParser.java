...
import org.mule.modules.janrain.processors.RegisterNativeTraditionalMessageProcessor;
...
public class RegisterNativeTraditionalDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RegisterNativeTraditionalMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "password_confirm", "password_confirm");
