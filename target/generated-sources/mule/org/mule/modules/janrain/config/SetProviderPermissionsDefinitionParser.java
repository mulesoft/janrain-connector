...
import org.mule.modules.janrain.processors.SetProviderPermissionsMessageProcessor;
...
public class SetProviderPermissionsDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetProviderPermissionsMessageProcessor.class.getName());
        ...
        parseProperty(builder, element, "permissions", "permissions");
