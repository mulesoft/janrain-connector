...
import org.mule.modules.janrain.processors.GetTokenMessageProcessor;
    ...
    extends AbstractDefinitionParser
{
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        parseProperty(builder, element, "grant_type", "grant_type");
        parseProperty(builder, element, "code", "code");
        parseProperty(builder, element, "redirect_uri", "redirect_uri");
        parseProperty(builder, element, "refresh_token", "refresh_token");
