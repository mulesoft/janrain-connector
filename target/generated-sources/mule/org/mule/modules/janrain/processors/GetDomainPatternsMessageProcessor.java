...
/**
 * GetDomainPatternsMessageProcessor invokes the {@link org.mule.modules.janrain.JanrainConnector#getDomainPatterns()} method in {@link JanrainConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.5", date = "2015-11-12T11:54:29-03:00", comments = "Build UNNAMED.1635.c9f644c")
public class GetDomainPatternsMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((JanrainConnector) object).getDomainPatterns();
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getDomainPatterns"), event, e);
        }
    }
    ...
    public Result<MetaData> getOutputMetaData(MetaData inputMetadata) {
        return new DefaultResult<MetaData>(new DefaultMetaData(getPojoOrSimpleModel(DomainPatterns.class)));
    }
