...
/**
 * AnalyticsAccessMessageProcessor invokes the {@link org.mule.modules.janrain.JanrainConnector#analyticsAccess(java.lang.String, java.lang.String)} method in {@link JanrainConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.5", date = "2015-11-12T11:54:29-03:00", comments = "Build UNNAMED.1635.c9f644c")
public class AnalyticsAccessMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedStart = ((String) evaluateAndTransform(getMuleContext(), event, AnalyticsAccessMessageProcessor.class.getDeclaredField("_startType").getGenericType(), null, start));
            final String _transformedEnd = ((String) evaluateAndTransform(getMuleContext(), event, AnalyticsAccessMessageProcessor.class.getDeclaredField("_endType").getGenericType(), null, end));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((JanrainConnector) object).analyticsAccess(_transformedStart, _transformedEnd);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("analyticsAccess"), event, e);
        }
    }
