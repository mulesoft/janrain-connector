...
public class RetrieveEntityTestCases extends JanrainTestParent {
	...
	public void testRetrieveEntity() {
		...
		MessageProcessor flow = lookupFlowConstruct("retrieve-entity");
		...
		try {			
			...
			Assert.assertFalse(payload.contains("\"stat\":\"error\""));
